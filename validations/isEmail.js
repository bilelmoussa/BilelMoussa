 const isEmail = (emailVal) =>
{
  ...
  let rex = new RegExp("^[A-Za-z0-9.-_]+@[A-Za-z0-9.-_]+.[A-Za-z]+$")
  let endofString = email.split('.');
  let ending = endofString.length - 1;
  let tld = endofString[ending];
  if (! email.match(rex)) {
    return false;
  }
